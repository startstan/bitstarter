...
$( '#date_demo__translations_rtl' ).pickadate({
    monthsFull: [ 'ÙŠÙ†Ø§ÙŠØ±', 'Ù�Ø¨Ø±Ø§ÙŠØ±', 'Ù…Ø§Ø±Ø³', 'Ø§Ø¨Ø±ÙŠÙ„', 'Ù…Ø§ÙŠÙˆ', 'ÙŠÙˆÙ†ÙŠÙˆ', 'ÙŠÙˆÙ„ÙŠÙˆ', 'Ø§ØºØ³Ø·Ø³', 'Ø³Ø¨ØªÙ…Ø¨Ø±', 'Ø§ÙƒØªÙˆØ¨Ø±', 'Ù†ÙˆÙ�Ù…Ø¨Ø±', 'Ø¯ÙŠØ³Ù…Ø¨Ø±' ],
...
if ( picker_method_trigger ) {
    picker_method_trigger.on( 'open', function() {
        console.log( 'Didnâ€™t open.. yet here I am!' )
    })
...
$( '.js__timepickerStart' ).pickatime({
	interval: 15,
    min: [00,00],
    max: [$("#slot1End").value,01]
})

$( '.js__timepickerEnd' ).pickatime({
	interval: 15,
    min: [00,00],
    max: [06,00]
})
